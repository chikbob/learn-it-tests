...
[![Questions](https://img.shields.io/badge/вопросов-317-247a70)](./src/questions.js)
...
Актуальный банк сформирован из исправленного единого файла в [`docs/question-sources`](./docs/question-sources). Варианты и правильные ответы переносятся из него без изменений. Для повторной генерации банка и SQL-миграции используется:
